(function (A) {
    A.extend(A.fn, {pstrength: function (B) {
            var B = A.extend({verdects: ["Muito Fraca!", "Fraca", "Média", "Forte", "Muito Forte"], colors: ["#f00", "#c06", "#f60", "#3c0", "#3f0"], scores: [10, 15, 30, 40], common: ["ne10", "sjcc", "jornal", "123456", "123", "portal", "admin", "senha", "abc", "abcde"], minchar: 8}, B);
            return this.each(function () {
                var C = A(this).attr("id");
                A(this).after("<div class=\"pstrength-minchar\" id=\"" + C + "_minchar\">Mínimo de caracteres : " + B.minchar + "</div>");
