                                ...
                                <div class="card-block">
                                    <form id="frmAdicionar" name="frmAdicionar" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control form-control-round" autocomplete="off" placeholder="Informe o Endereço" name="strAddress" id="strAddress" maxlength="100" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control form-control-round required" autocomplete="off" placeholder="Informe o Número" name="strNumber" id="strNumber" maxlength="100" required="">
                                            </div>
                                        </div>
